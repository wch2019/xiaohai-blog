...
public class TagsController {
    ...
    @Operation(summary = "查询标签选择列表", security = {@SecurityRequirement(name = Constants.SESSION_ID)})
    @GetMapping("/option-select")
    public Response<List<TagsDto>> optionSelect() {
        return Response.success("查询标签选择列表成功！", tagsService.optionSelect());
    }
}
