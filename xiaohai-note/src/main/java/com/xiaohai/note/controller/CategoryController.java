...
public class CategoryController {
    ...
    @Operation(summary = "查询分类选择列表", security = {@SecurityRequirement(name = Constants.SESSION_ID)})
    @GetMapping("/option-select")
    public Response<List<CategoryDto>> optionSelect() {
        return Response.success("查询分类选择列表成功！", categoryService.optionSelect());
    }
}
